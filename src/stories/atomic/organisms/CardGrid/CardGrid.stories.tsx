...
const sampleItems: CardGridItem[] = [
  {
    ...
    actions: <Button size="small" label="View Details" />,
  },
  {
    id: 2,
    title: 'Product B',
    ...
    actions: <Button size="small" label="Learn More" />,
  },
  {
    id: 3,
    title: 'Product C',
    ...
    actions: <Button size="small" label="Buy Now" />,
  },
  {
    id: 4,
    title: 'Product D',
    ...
    actions: <Button size="small" label="Add to Cart" />,
  },
  {
    id: 5,
    title: 'Product E',
    ...
    actions: <Button size="small" label="Explore" />,
  },
  {
    id: 6,
    title: 'Product F',
    ...
    actions: <Button size="small" label="Discover" />,
  },
];
